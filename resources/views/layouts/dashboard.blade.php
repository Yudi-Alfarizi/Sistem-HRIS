...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('template/dist/assets/compiled/png/Logo.png') }}" type="image/x-icon">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ url('/') }}">
                                <img src="{{ asset('template/dist/assets/compiled/png/Logo_Text.png') }}"
                                    alt="Logo"
                                    style="height: 2.5rem; width: auto; max-width: 180px; object-fit: contain;"
                                    srcset="">
                            </a>
                        </div>
