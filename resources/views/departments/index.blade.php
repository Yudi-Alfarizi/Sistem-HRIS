        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">
                        Informasi Daftar Departemen
                    </h5>
                </div>
                <div class="card-body">
                    <div class="d-flex">
                        <a href="{{ route('departments.create') }}" class="btn btn-primary mb-3 ms-auto">Tambah
                            Departemen</a>
                    </div>
                    @if (session('success'))
                        ...
                        <tbody>
                            @foreach ($departments as $department)
                                <tr>
                                    ...
                                    <td>
                                        @if ($department->status == 'tidak_aktif')
                                            <span class="text-warning">Tidak Aktif</span>
                                        @elseif ($department->status == 'aktif')
